...
dbusRef=$(kdialog --title "Preparing an archive for the teacher" --progressbar "Initializing...                                                                                                                                       " 11)
...
studentgroup=$(debug/facturation disable-dump-usage student-group | tr -cd '[a-zA-Z \\-]') || endScriptErrorBox "Checking student details..." "An error occurred while gathering student details"
